export interface CarbonProfile {
  transportMode: 'car-solo' | 'car-pool' | 'public-transit' | 'bike-walk' | 'mixed';
  commuteDistanceKm: number;
  flightsPerYear: number;
  dietType: 'high-meat' | 'moderate-meat' | 'pescatarian' | 'vegetarian' | 'vegan';
...
export interface CarbonTwin {
  ...
  equivalents: { treesPlanted: number; phoneChargesSaved: number; carsOffRoad: number };
}
