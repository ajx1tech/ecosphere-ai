 ...
 */
export async function saveProfile(userId: string, profile: CarbonProfile, breakdown: FootprintBreakdown): Promise<void> {
  try {
 ...
 */
export async function getProfileHistory(userId: string): Promise<{ profile: CarbonProfile; breakdown: FootprintBreakdown; timestamp: Date }[]> {
  try {
 ...
 */
export async function saveMissionProgress(userId: string, missionId: string, completed: boolean): Promise<void> {
  try {
