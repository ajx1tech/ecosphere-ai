...
export default function CarbonTwinComparison({ twin }: { twin: CarbonTwin }) {
  return (
    <div className="w-full space-y-8" aria-label={`Comparison with your Carbon Twin. You: ${twin.currentFootprint} kg. Twin: ${twin.twinFootprint} kg. Savings: ${twin.savingsKg} kg.`}>
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <div className="text-4xl font-black text-orange-400 mb-4">
            {twin.currentFootprint.toLocaleString()} <span className="text-lg font-medium text-slate-400">kg CO2e</span>
          </div>
          <p className="text-slate-400 text-sm">Your actual computed footprint based on your current habits.</p>
        </motion.div>
        ...
        >
          ...
          <div className="text-4xl font-black text-emerald-400 mb-4">
            <AnimatedCounter value={twin.twinFootprint} /> <span className="text-lg font-medium text-slate-400">kg CO2e</span>
          </div>
          <p className="text-emerald-100/70 text-sm mb-4">An optimized version of you who:</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 text-center">
          ...
          <div className="text-xs text-slate-400 uppercase tracking-widest mt-1">Trees Planted</div>
        </div>
        <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 text-center">
          <div className="text-3xl mb-2">📱</div>
          ...
          <div className="text-xs text-slate-400 uppercase tracking-widest mt-1">Phone Charges</div>
        </div>
        <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 text-center">
          <div className="text-3xl mb-2">🚗</div>
          ...
          <div className="text-xs text-slate-400 uppercase tracking-widest mt-1">Cars Off Road / Yr</div>
        </div>
      </div>
    </div>
  );
