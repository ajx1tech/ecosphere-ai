              ...
              <input
                ...
                onChange={(e) =>
                  updateProfile(
                    ...
                    Math.max(0, Math.min(5000, Number(e.target.value)))
                  )
                }
                className="w-full bg-slate-800 text-slate-100 rounded-lg p-3 border border-emerald-900/50 focus:ring-2 focus:ring-emerald-500"
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <div>
              <label
                htmlFor="foodDelivery"
                className="block text-sm font-medium text-emerald-200 mb-2"
              >
                Food Delivery (Times/Week)
              </label>
              <input
                id="foodDelivery"
                type="number"
