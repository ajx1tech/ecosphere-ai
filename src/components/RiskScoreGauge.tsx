...
export default function RiskScoreGauge({
  ...
  const getExplanation = () => {
    switch (category) {
      case 'Excellent':
        return 'Your emissions are exceptionally low.'
      case 'Low':
        return 'You are well below average. Keep it up!'
      case 'Moderate':
        return 'Your footprint is average, with room for easy wins.'
      case 'High':
        return 'Your emissions are above average. Action is recommended.'
      case 'Critical':
        return 'Your footprint is very high. Prioritize major reductions.'
      default:
        return ''
    }
  }
